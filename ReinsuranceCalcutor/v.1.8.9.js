$(function () {
        ...
        if (!isXolActive && !isAggActive && !isQuotaActive) {
            ...
            baseBlocks.each((index, element) => {
                ...
                if (currentLoss === 0) {
                    ...
                    $(element).find('.quota-block--spacer').css('height', `${$(quotaBlocks).eq(index).height()}px`)
                    $(element).find('.quota-block--spacer').css('min-height', `${$(quotaBlocks).eq(index).height()}px`)
            ...
            $('.reinsurance--graph--block.base').each((index, element) => {
                if ($(element).height() < 80) {
                    ...
                    $(element).find('.quota-block--spacer').css('height', `${30}px`)
                    $(element).find('.quota-block--spacer').css('min-height', `${30}px`)
                }
    ...
    $('.reinsurance--apply--button').on('click', (e) => {
        $('.reinsurance--graph--block').remove()
        handleCalculations()
        /*  $('.reinsurance--graph--block').css('opacity', 0).animate({ opacity: 1 }, 300);
         $('.reinsurance--graph--block').fadeTo(0, 0).fadeTo(300, 1); */
